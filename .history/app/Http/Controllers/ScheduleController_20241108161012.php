...
class ScheduleController extends Controller
{
    ...
    {
        $schedules = Schedule::with(['department', 'scheduledWorkers.worker' => function($query) {
        $query->select('document_number', 'first_name', 'last_name');  // Aquí seleccionas los campos que necesitas del Worker
        }])->get();
