...
class HandbookController extends Controller
{
    public static function list(Request $request)
    {
        ...
        $handbooks = Handbook::orderBy('handbook_id', 'desc')->with('creation:user_id,username','department:department_id,department_name','update:user_id,username')->simplePaginate($perPage);
